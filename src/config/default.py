...
# 蓝鲸业务集ID
try:
    BLUEKING_BIZ_ID = int(os.getenv("BLUEKING_BIZ_ID", 2))
except (TypeError, ValueError):
    BLUEKING_BIZ_ID = 2
# 作业平台版本
JOB_VERSION = os.getenv("JOB_VERSION") or "V2"
# 资源池业务ID
...
GSE_WIN_AGENT_RUN_DIR = os.getenv("BKAPP_GSE_WIN_AGENT_LOG_DIR") or "C:\\gse\\logs"
