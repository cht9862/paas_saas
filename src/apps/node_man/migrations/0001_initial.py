    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('task_status', models.IntegerField(choices=[
                 (0, '任务准备中'), (1, '任务进行中'), (2, '任务已完成'), (3, '任务失败')], default=0, verbose_name='任务状态')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[
                 ('official', 'official'), ('external', 'external'), ('scripts', 'scripts')], max_length=32, verbose_name='所属范围')),
                ('launch_node', models.CharField(choices=[
                 ('agent', 'agent'), ('proxy', 'proxy'), ('all', 'all')], default='all', max_length=32, verbose_name='宿主节点类型要求')),
                ('config_file', models.CharField(blank=True, max_length=128, null=True, verbose_name='配置文件名称')),
                ('config_format', models.CharField(blank=True, choices=[
                 ('json', 'json'), ('yaml', 'yaml'), ('', ''), (None, None)], default='json', max_length=32, null=True, verbose_name='配置文件格式类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os_type', models.CharField(choices=[
                 ('LINUX', 'LINUX'), ('WINDOWS', 'WINDOWS'), ('AIX', 'AIX')], default='linux', max_length=45, verbose_name='操作系统')),
                ('node_type', models.CharField(choices=[
                 ('AGENT', 'AGENT'), ('PROXY', 'PROXY'), ('PAGENT', 'PAGENT')], max_length=45, verbose_name='节点类型')),
                ('node_from', models.CharField(choices=[
                 ('CMDB', 'CMDB'), ('EXCEL', 'EXCEL'), ('INSTALL', 'INSTALL')], default='nodeman', max_length=45, verbose_name='节点来源')),
                ('ap_id', models.IntegerField(null=True, verbose_name='接入点ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auth_type', models.CharField(choices=[('PASSWORD', 'PASSWORD'), ('KEY', 'KEY'), (
                    'TJJ_PASSWORD', 'TJJ_PASSWORD')], default='PASSWORD', max_length=45, verbose_name='认证类型')),
                ...
                ('extra_data', django_mysql.models.JSONField(blank=True, default=dict, null=True, verbose_name='额外认证资料')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_type', models.CharField(choices=[('INSTALL_PROXY', 'INSTALL_PROXY'), ('INSTALL_AGENT', 'INSTALL_AGENT'), ('RESTART_PROXY', 'RESTART_PROXY'), ('RESTART_AGENT', 'RESTART_AGENT'), ('REINSTALL_PROXY', 'REINSTALL_PROXY'), ('REINSTALL_AGENT', 'REINSTALL_AGENT'), ('REPLACE_PROXY', 'REPLACE_PROXY'), ('UNINSTALL_AGENT', 'UNINSTALL_AGENT'), ('REMOVE_AGENT', 'REMOVE_AGENT'), ('UNINSTALL_PROXY', 'UNINSTALL_PROXY'), ('UPGRADE_PROXY', 'UPGRADE_PROXY'), ('UPGRADE_AGENT', 'UPGRADE_AGENT'), ('IMPORT_PROXY', 'IMPORT_PROXY'), ('IMPORT_AGENT', 'IMPORT_AGENT'), (
                    'RESTART_AGENT', 'RESTART_AGENT'), ('RESTART_PROXY', 'RESTART_PROXY'), ('MAIN_START_PLUGIN', 'MAIN_START_PLUGIN'), ('MAIN_STOP_PLUGIN', 'MAIN_STOP_PLUGIN'), ('MAIN_RESTART_PLUGIN', 'MAIN_RESTART_PLUGIN'), ('MAIN_RELOAD_PLUGIN', 'MAIN_RELOAD_PLUGIN'), ('MAIN_DELEGATE_PLUGIN', 'MAIN_DELEGATE_PLUGIN'), ('MAIN_UNDELEGATE_PLUGIN', 'MAIN_UNDELEGATE_PLUGIN'), ('MAIN_INSTALL_PLUGIN', 'MAIN_INSTALL_PLUGIN'), ('UPDATE_AUTHINFO', 'UPDATE_AUTHINFO'), ('PACKING_PLUGIN', 'PACKING_PLUGIN')], default='INSTALL_PROXY', max_length=45, verbose_name='作业类型')),
                ...
                ('status', models.CharField(choices=[('PENDING', '等待执行'), ('RUNNING', '正在执行'), ('SUCCESS', '执行成功'), ('FAILED', '执行失败'), (
                    'PART_FAILED', '部分失败'), ('TERMINATED', '已终止')], default='RUNNING', max_length=45, verbose_name='任务状态')),
                ('global_params', django_mysql.models.JSONField(blank=True, default=dict, null=True, verbose_name='全局运行参数')),
                ('statistics', django_mysql.models.JSONField(blank=True, default=dict, null=True, verbose_name='任务统计信息')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('QUEUE', 'QUEUE'), ('RUNNING', 'RUNNING'),
                                                     ('SUCCESS', 'SUCCESS'), ('FAILED', 'FAILED')], default='QUEUE', max_length=45)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os', models.CharField(choices=[('windows', 'windows'), ('linux', 'linux'),
                                                 ('aix', 'aix')], db_index=True, default='linux', max_length=32, verbose_name='系统类型')),
                ('cpu_arch', models.CharField(choices=[('x86', 'x86'), ('x86_64', 'x86_64'), ('powerpc',
                                                                                              'powerpc')], db_index=True, default='x86_64', max_length=32, verbose_name='CPU类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('os', models.CharField(choices=[('windows', 'windows'), ('linux', 'linux'),
                                                 ('aix', 'aix')], default='linux', max_length=32, verbose_name='系统类型')),
                ('process_name', models.CharField(default=None, max_length=128, null=True, verbose_name='实际二进制执行文件名')),
                ('port_range', models.TextField(blank=True, default='', null=True, verbose_name='插件允许使用的端口范围，格式 1,3,6-8,10-100')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('RUNNING', 'RUNNING'), ('UNKNOWN', 'UNKNOWN'), (
                    'TERMINATED', 'TERMINATED')], db_index=True, default='UNKNOWN', max_length=45, verbose_name='进程状态')),
                ('is_auto', models.CharField(choices=[('AUTO', 'AUTO'), ('UNAUTO',
                                                                         'UNAUTO')], default='AUTO', max_length=45, verbose_name='是否自动启动')),
                ('version', models.CharField(blank=True, default='', max_length=45, null=True, verbose_name='进程版本')),
                ('proc_type', models.CharField(choices=[
                 ('AGENT', 'AGENT'), ('PLUGIN', 'PLUGIN')], default='AGENT', max_length=45, verbose_name='进程类型')),
                ...
                ('source_type', models.CharField(choices=[
                 ('default', '默认'), ('subscription', '订阅'), ('debug', '调试')], default='default', max_length=128, verbose_name='来源类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('object_type', models.CharField(choices=[('HOST', '主机'),
                                                          ('SERVICE', '服务')], max_length=20, verbose_name='对象类型')),
                ('node_type', models.CharField(choices=[
                 ('TOPO', '拓扑'), ('INSTANCE', '实例'), ('INSTANCE', '实例')], max_length=20, verbose_name='节点类型')),
