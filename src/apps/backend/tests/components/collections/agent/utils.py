...
from apps.node_man import constants as const, models
...
DEFAULT_INSTANCE_ID = "host|instance|host|20.8.3.1-0-0"
...
class SshManMockClient:
    def __init__(
        self, get_and_set_prompt_return=None, send_cmd_return_return=None, safe_close_return=None, ssh_return=None,
    ):
...
class CMDBMockClient:
    def __init__(
        self, add_host_to_resource_result=None, search_business_result=None, search_host_result=None,
    ):
        self.cc = MagicMock()
        ...
        self.cc.search_host = MagicMock(return_value=search_host_result)
