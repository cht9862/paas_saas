...
from apps.backend.components.collections.agent import QueryTjjPasswordComponent, QueryTjjPasswordService
...
class UseTjjPwdSuccessTest(TestCase, ComponentTestMixin):
    ...
    TJJ_GET_PASSWORD_RETURN = (True, {"20.8.3.1": "fddsrgytrwsehygrt"}, {}, "success")
...
class UseTjjPwdFailedTest(TestCase, ComponentTestMixin):
    ...
    TJJ_GET_PASSWORD_FAILED_IP_RETURN = (True, {}, {"20.8.3.1": {"Message": "host not exists"}}, "host not exists")
