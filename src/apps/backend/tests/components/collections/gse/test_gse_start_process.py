...
class GseStartProcessComponentTestCase(TestCase, ComponentTestMixin):
    ...
    GSE_TASK_RESULT = {
        "success": [
            {"ip": "10.10.1.1", "bk_cloud_id": 0, "bk_supplier_id": 0, "error_code": 0, "error_msg": "", "content": ""}
        ],
        "pending": [],
        "failed": [],
    }
            ...
            ComponentTestCase(
                ...
                schedule_assertion=ScheduleAssertion(
                    ...
                    outputs={
                        ...
                        "ex_data": "以下主机操作进程失败：[10.0.0.2] Fail to register, for the process info already exists.",
                    },
                    callback_data=None,
